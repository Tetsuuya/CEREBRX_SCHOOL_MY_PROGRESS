        ...
        <div class="row">       
            ...
            <div class="col-md-4">           
                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('idproduction/teacher/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <label for="exampleInputEmail1" class="required"><?php echo $this->lang->line('teacher_name'); ?></label>
							...
							<div class="form-group">
                                ...
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('teacher_midname'); ?></label>
							...
							<div class="form-group">
                                ...
                                <label for="exampleInputEmail1 required" class="required"><?php echo $this->lang->line('teacher_lastname'); ?></label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="exampleInputEmail1 required"><?php echo $this->lang->line('email'); ?></label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="exampleInputFile required" class="required"> <?php echo $this->lang->line('gender'); ?> &nbsp;&nbsp;</label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="exampleInputEmail1 required" class="required"><?php echo $this->lang->line('date_of_birth'); ?></label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="exampleInputEmail1 required" class="required"><?php echo $this->lang->line('address'); ?></label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="exampleInputEmail1 required" class="required"><?php echo $this->lang->line('phone'); ?></label>
                                        ...
                                        foreach ($teacherlist as $teacher) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>idproduction/teacher/view/<?php echo $teacher['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >

                                                        <i class="fa fa-reorder"></i>

                                                    </a>

                                                    <a href="<?php echo base_url(); ?>idproduction/teacher/edit/<?php echo $teacher['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
