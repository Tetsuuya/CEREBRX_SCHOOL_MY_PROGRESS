            ...
            <div class="col-md-3">              
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body box-profile">
							...
							$image = base_url().$teacher['image'];

							if(!@GetImageSize($image)){

								$image = base_url().'uploads/teacher_images/no_image.png';
                        ...
                        <h3 class="profile-username text-center"><?php echo $teacher['name'].' '.$teacher['middlename'].' '.$teacher['lastname'] ?></h3>
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                ...
                                <b><?php echo 'Type';//$this->lang->line('address'); ?></b> <a class="pull-right text-aqua"><?php echo $teacher['type_teacher'] ?></a>

                            </li>

                            <li class="list-group-item">

                                <b><?php echo $this->lang->line('class'); ?> & <?php echo $this->lang->line('section'); ?></b> <a class="pull-right"><?php echo $class_advisory; ?></a>
                            ...
                            <li class="list-group-item">
                                ...
                                <b><?php echo $this->lang->line('active'); ?></b> <a class="pull-right text-aqua"><?php echo $teacher['is_active']  ?></a>
                                ...
                                <tbody>                                     
                                        ...
                                        foreach ($teachersubject as $subject) {                                          
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name"><?php echo $subject->semester; ?></td>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.schedule_modal', function () {
        ...
        var teacher_middlename = '<?php echo $teacher["middlename"] ?>';

        var teacher_lastname = '<?php echo $teacher["lastname"] ?>';

        $.ajax({

            type: "post",

            url: base_url + "idproduction/teacher/getlogindetail",
            ...
            success: function (response) {         
                ...
                data += '<p class="lead text text-center">' + teacher_name +" "+ teacher_middlename +" "+ teacher_lastname +'</p>';
