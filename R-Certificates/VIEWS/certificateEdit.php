            ...
            <div class="col-md-4">               
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> Edit Awards</h3>
                    </div>  
                    <form action="<?php echo site_url("teacher/awards/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="category" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name', $awards['name']); ?>" />
                                <span class="text-danger"><?php echo form_error('name'); ?></span>
                            </div>
                            <label class="radio-inline">
                                <input type="radio" value="Academics" name="type"  <?php if (set_value('type', $awards['type']) == "Academics") echo "checked"; ?> checked>Academics
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="type" <?php if (set_value('type', $awards['type']) == "Extra-Curricular") echo "checked"; ?> value="Extra-Curricular">Extra-Curricular
                            </label>  
                        </div>
            ...
            <div class="col-md-8">               
                <div class="box box-primary" id="sublist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Award List</h3>
                    </div>
                    <div class="box-body">
                                ...
                                <tbody>
                                    <?php if (empty($awardslist)) {
                                        ...
                                        foreach ($awardslist as $award) {
                                            ?>
                                            <tr>
                                                <td class="mailbox-name"> <?php echo $award['name'] ?></td> 
                                                <td class="mailbox-name"><?php echo $award['type'] ?></td>
                                                <td class="mailbox-date pull-right no-print">
													<a href="<?php echo base_url(); ?>teacher/awards/edit/<?php echo $award['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>teacher/awards/delete/<?php echo $award['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
