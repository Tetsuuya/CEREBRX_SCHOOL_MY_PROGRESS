            ...
            <div class="col-md-12">              
                ...
                <div class="box box-primary" id="sublist"> 
                    ...
                    <div class="box-body">
                        ...
                        <form id='form1' action="<?php echo site_url('registrar/report/master_sheet') ?>"  method="post" accept-charset="utf-8">
                    ...
                    <div class="box box-info" id="attendencelist">
                        ...
                        <div class="box-header ptbnull" >
                            ...
                            <div>
                               ...
                               <form id='form1mastersheet' class=" pull-right" action="<?php echo site_url('registrar/report/master_sheet') ?>"  method="post" accept-charset="utf-8">
                                    ...
                                    <button type="button" id="printsms" class="btn btn-primary btn-sm" style="margin-top: 3px;margin-bottom: -5px">PRINT MASTER SHEET</button>
										...
										foreach ($studentlist_male as  $student_value) {
											...
											if( $quarter != "final"){
												...
												if( $semester_id ){
							                        ...
							                        $student_conduct = $this->conductimportsubject_model->getStudentConduct( $student_id, $quarter, $class_id, $semester_id, $strand_id, $session_id  );

					                            } else {

					                                $student_conduct = $this->conductimportsubject_model->getStudentConduct( $student_id, $quarter, $class_id, null,null, $session_id );
...
<script type="text/javascript">
	 ...
	 $( "#printsf5" ).click(function() {
        ...
        $("#form1mastersheet").attr("action", "<?php echo site_url('registrar/report/print_master_sheet_sf5') ?>"); 
    ...
    $( "#printsms" ).click(function() {
        ...
        $("#form1mastersheet").attr("action", "<?php echo site_url('registrar/report/master_sheet') ?>"); 
