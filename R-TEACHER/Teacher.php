...
class Teacher extends CI_Controller {
	...
	function index() {
        ...
        $this->load->view('registrar/teacher/teacherList', $data);
	...
	function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['classlist'] = $class;
           $this->load->view('layout/registrar/header', $data);
            $this->load->view('registrar/teacher/teacherCreate', $data);
            $this->load->view('layout/registrar/footer', $data);
        } else {
            ...
            redirect('registrar/teacher/index');
        }
	}
	...
	function view($id) {
        ...
        $this->load->view('layout/registrar/header', $data);
        $this->load->view('registrar/teacher/teacherShow', $data);
        $this->load->view('layout/registrar/footer', $data);
    }
	 ...
	 function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['teacherlist'] = $teacher_result;
            $this->load->view('layout/registrar/header', $data);
            $this->load->view('registrar/teacher/teacherEdit', $data);
            $this->load->view('layout/registrar/footer', $data);
        } else {
			$type_teacher = $this->input->post('type_teacher');
			$class_id = $this->input->post('class_id');
    ...
    public function assignteacher() {
        ...
        if ($this->form_validation->run() == FALSE ) {
			$this->load->view('layout/registrar/header', $data);
			$this->load->view('registrar/teacher/assignTeacher', $data);
			$this->load->view('layout/registrar/footer', $data);	
		} else {
	 ...
	 function getSubjectTeachers()
    {
		...
		$this->load->view('layout/registrar/header', $data);
        $this->load->view('registrar/teacher/classList', $data);
        $this->load->view('layout/registrar/footer', $data);
    }
	...
	function assign_advisers(){
		 ...
		 redirect('registrar/teacher/advisers/?session_id='.$get_session_id );
	}
}
