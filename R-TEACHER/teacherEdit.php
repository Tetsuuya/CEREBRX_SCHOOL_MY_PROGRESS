        ...
        <div class="row">           
            <div class="col-md-4">             
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('registrar/teacher/edit/' . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                        <div class="box-body">
                                        ...
                                        foreach ($teacherlist as $teacher_display) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right"">
                                                    <a href="<?php echo base_url(); ?>registrar/teacher/view/<?php echo $teacher_display['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
                                                        <i class="fa fa-reorder"></i>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>registrar/teacher/edit/<?php echo $teacher_display['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
