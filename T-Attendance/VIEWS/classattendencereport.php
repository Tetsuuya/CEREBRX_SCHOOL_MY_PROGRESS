                        ...
                        <div class="box-body table-responsive">
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right">
                                        ...
                                        if( $type_teacher == 'Advisory' ){                                             
                                            ?> 
                                            <form id='form1' action="<?php echo site_url('teacher/stuattendence/classattendencereportexcel') ?>"  method="post" accept-charset="utf-8">
                                            	<input type="hidden" name="class_id" value="<?php echo $class_id ?>">
    				                        	<input type="hidden" name="section_id" value="<?php echo $section_id; ?>">
    				                        	<input type="hidden" name="month_selected" value="<?php echo $month_selected ?>">
                                           		<button type="submit" class="btn btn-primary btn-sm pull-right" style="margin-bottom: 5px;">PRINT DEPED FORM 2</button>
                                            </form>
                                            <?php 
                                        }
                                        ?>
                            ...
                            if (!empty($resultlist_male) || !empty($resultlist_female)) {
                                ...
                                <table class="table table-hover table-striped table-bordered xyz example">
                                    ...
                                    <tbody>
                                        <?php if (empty($student_array_male) && empty($student_array_female)) {
                                            ?>
                                            <tr>
											...
											if( !empty( $student_array_male )){
												?>
												<tr>
													<td><b style="color:#271D51;">Male</b></td>
												</tr>
												<?php
												$row_count = 1;
												foreach ($student_array_male as $student_key => $student_value) {
													?>  
													<tr>
														<th class="tdclsname"  style="width:500px !important" ><?php echo $student_value['lastname'] . ", " . $student_value['firstname']; ?> 
														</th>
														<?php
														foreach ($attendence_array as $at_key => $at_value) {  
															// $student_specific_detail = $this->student_model->getStudentbySession( $student_value['student_session_id'] ); 
															$retxx = $this->stuattendence_model->get_attendance_by_date_user_display(  $student_value['student_session_id'] ,  $at_value  );
														  
															?>
															<th class="tdcls text text-center">
																<?php 
																	//echo $resultlist[$at_value][$student_value['student_session_id']]['key']; 
																	echo $retxx; 
																?>
															</th>
											...
											if( !empty( $student_array_female )){
												?>
												<tr>
													<td><b style="color:#271D51;">Female</b></td>
												</tr>
												<?php
												 foreach ($student_array_female as $student_key => $student_value) {
													?>
													<tr>
														<th class="tdclsname"  style="width:500px !important"><?php echo $student_value['lastname'] . ", " . $student_value['firstname']; ?> 
														</th>
