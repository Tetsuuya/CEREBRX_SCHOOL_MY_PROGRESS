                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="date" name="date"  placeholder="" type="text" class="form-control date"  value="<?php echo set_value('date',date('m/d/Y')); ?>" />
                                        <span class="text-danger"><?php echo form_error('date'); ?></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('publish_on'); ?></label>
                                        <input id="publish_date" name="publish_date"  placeholder="" type="text" class="form-control date"  value="<?php echo set_value('publish_date',date('m/d/Y')); ?>" />
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="checkbox">
                                            <label><input type="checkbox" id="notify_parent" name="visible[]"  value="parent" <?php echo set_checkbox('visible[]', 'parent', false) ?> /> <b><?php echo $this->lang->line('parent'); ?>s </b></label>
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    <input type="hidden" id="parent_custom" name="parent_custom">
                                    <!-- modification: hidden field added to store targeted specific student IDs -->
                                    <input type="hidden" id="custom_student_ids" name="custom_student_ids">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        ?> 
        <!--modification: added for send to all or specific parent-->
            <div class="class-section-item-group" style="margin-bottom: 12px; border-bottom: 1px dashed #eee; padding-bottom: 12px;">
                <div class="checkbox" style="margin-top: 0; margin-bottom: 5px;">
                      <label><input class="parent_input class-section-chk" name="parent_notify[]" type="checkbox" value="<?php echo $class['class_id'] ?>" data-section="<?php echo $class['section_id'] ?>" checked="true"><b><?php echo $class['class_name'].' - '.$class['section_name']  ?></b></label>
                </div>
                
                <div class="student-target-selectors" style="margin-left: 20px; display: block;">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        // modification: uncheck "Send to All" checkbox if any class-section checkbox is unchecked
                ...
                success: function(data) {
                    ...
                    data.forEach(function(student) {
                        ...
                        item.on('click', function(e) {
                            ...
                            // isplay the parent/guardian phone number preview
            ...
            $(".class-section-item-group").each(function() {
                ...
                if (chk.is(':checked')) {
                    ...
                    if (targetType === 'single') {
                        ...
                        // targets the entire class-section
                        map.push([{ 'class_id': class_id, 'section_id': section_id }]);
                    }
                }
            });
