                ...
                <div class="table-container">
                        ...
                        <table class="grades-table">
                            ...
                            <?php foreach ($session['subjects'] as $subject): ?>
                                <tr>
                                    ...
                                    $has_grades = false;
                                    for ($q = 1; $q <= 4; $q++): 
                                        $grade = $subject['grades'][$q] ? $subject['grades'][$q] : null;
                                        if (!empty($grade)) {
                                            $total_per_q[$q] += $grade;
                                            $has_grades = true;
                                        }
                    ...
                    <?php else: ?>
                            ...
                            <?php foreach ($session['subjects'] as $subject): ?>
                                <?php if ($subject['semester'] == 1): ?>
                                    <tr>
                                        <td><?= htmlspecialchars($subject['name']) ?></td>
                                        <?php
                                        $q1 = $subject['grades'][1] ? $subject['grades'][1] : null;
                                        $q2 = $subject['grades'][2] ? $subject['grades'][2] : null;
                        ...
                        <table class="grades-table">
                            ...
                            <tbody>
                            <?php
                            $total_q3 = 0; $total_q4 = 0; $total_final = 0; $count = 0;
                            ?>
                            <?php foreach ($session['subjects'] as $subject): ?>
                                <?php if ($subject['semester'] == 2): ?>
                                    <tr>
                                        <td><?= htmlspecialchars($subject['name']) ?></td>
                                        <?php
                                        $q3 = $subject['grades'][3] ? $subject['grades'][3] : null;
                                        $q4 = $subject['grades'][4] ? $subject['grades'][4] : null;
                                        $final = $subject['final_grade'] ?$subject['final_grade'] : null;

                                        if (!empty($q3)) $total_q3 += $q3;
                                        if (!empty($q4)) $total_q4 += $q4;
                                        if (!empty($final)) $total_final += $final;

                                        if (!empty($q3) || !empty($q4) || !empty($final)) $count++;
                                        ?>
                                        <td><?= !empty($q3) ? $q3 : '-' ?></td>
                                        <td><?= !empty($q4) ? $q4 : '-' ?></td>
                                        <td><?= !empty($final) ? $final : '-' ?></td>
                            ...
                            <tr style="font-weight: bold; background-color: #f9f9f9;">
                                ...
                                <td><?= $count ? round($total_q4 / $count, 2) : '-' ?></td>
                                <td><?= $count ? round($total_final / $count, 2) : '-' ?></td>
                            </tr>
                            </tbody>
                        </table>
