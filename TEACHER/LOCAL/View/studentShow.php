            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                      ...
                      <!--   <li class="pull-right">
                            <a href="<?php echo base_url(); ?>/teacher/student/edit/<?php echo $student['id'] ?>" class="btn btn-warning btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                        ...
                        <?php if (!empty($adviser)) : ?>
                            <li class="pull-right">
                                ...
                                title="<?php echo $this->lang->line('login_detail'); ?>">
                                    <i class="fa fa-key"></i>
                        ...
                        <div class="tab-pane active" id="activity"> 
                            ...
                            <table class="table table-hover table-striped">
                                <tr>
                                    ...
                                    <td  class="col-md-5"><?php echo $student['father_name'].' '.$student['father_midname'].' '.$student['father_lastname']; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $student['mother_name'].' '.$student['mother_midname'].' '.$student['mother_lastname']; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $student['guardian_name'].' '.$student['guardian_midname'].' '.$student['guardian_lastname']; ?></td>
                                </tr>
                                <tr>
                        ...
                        <div class="tab-pane" id="exam">
                            ...
                            if (empty($list_of_subjects) ) {
                                ...
                                if( $enableStrand ){
                                    ...
                                    $display_conduct = isset($gradingsettings->display_conduct)?$gradingsettings->display_conduct:'no';
